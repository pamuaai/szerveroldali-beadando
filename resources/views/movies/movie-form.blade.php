...
<div class="form-group">
    ...
    <input type="text" name="title" value="{{ old('title') ?? $movie->title }}" class="form-control" id="inputTitle"
...
<div class="form-group">
    ...
    <input type="text" name="year" value="{{ old('year') ?? $movie->year }}" class="form-control" id="inputYear"
